<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div class="border-t border-lavender-200 pt-4 mt-4">
            ...
            <!-- Disability Type -->
            <div class="mb-3">
                <x-input-label for="disability_type" :value="__('Do you have a registered disability?')" class="text-indigo-700 font-bold mb-2" />
                <select 
                    id="disability_type" 
        ...
        <button 
            type="submit"
            class="w-full py-4 px-6 rounded-2xl bg-indigo-700 text-white font-black text-base transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl active:translate-y-0 mt-6"
        >
            {{ __('Create Account') }}
        </button>
